...
//		}
		...
		if(text != null){
			...
			params.setMargins(DpUtils.dpToPx(5, getResources()), DpUtils.dpToPx(5, getResources()), DpUtils.dpToPx(5, getResources()), DpUtils.dpToPx(5, getResources()));
...
//					textView.setLayoutParams(params);
		...
		rippleSpeed = attrs.getAttributeFloatValue(MATERIALDESIGNXML,
				"rippleSpeed", DpUtils.dpToPx(6, getResources()));
	}
...
//		centrarTexto();
		super.onDraw(canvas);
		if (x != -1) {
			Rect src = new Rect(0, 0, getWidth()- DpUtils.dpToPx(6, getResources()), getHeight()- DpUtils.dpToPx(7, getResources()));
			Rect dst = new Rect(DpUtils.dpToPx(6, getResources()), DpUtils.dpToPx(6, getResources()), getWidth()- DpUtils.dpToPx(6, getResources()), getHeight()- DpUtils.dpToPx(7, getResources()));
